  ...
  <div class="app-container">
    <div class="el-card">
      <div class="el-card__header">
        <div class="clearfix"><strong>动态详情</strong></div>
      </div>
...
<script>
  import { detailsGetInformation } from '@/api/information'
  ...
  export default {
    ...
    created() {
      this.detailsGetInformation()
    },
    methods: {
      // 查询详细
      detailsGetInformation() {
        this.loading = true
        detailsGetInformation(this.$route.params.id).then(response => {
