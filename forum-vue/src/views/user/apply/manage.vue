  ...
  <div class="wrapper">
    ...
    <article>
      <div class="page whitebg">
        ...
        <div class="page-box">
          <h2 class="page-box-title">我的加入</h2>
          <div class="page-box-content">
            <div>
              ...
              <el-table v-loading="loading" :data="tableData" ref="tableRef" @selection-change="handleSelectionChange">
                <el-table-column label="小组名称" align="center" prop="groups.name" min-width="120" :show-overflow-tooltip='true'/>
...
<script>
  ...
  import { dataApply, dynamicListApply, listLimitApply, countApply, dynamicCountApply, allApply, getApply, detailsGetApply, dynamicGetApply, addApply, editApply, delApply, delListApply } from "@/api/apply";
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        dataApply(this.queryParams).then(response => {
      ...
      handleDetails(row) {
        this.$router.push({ path: '/groups-details/' + row.groupsId})
      },
      // 单个删除按钮操作
      handleDelete(row) {
