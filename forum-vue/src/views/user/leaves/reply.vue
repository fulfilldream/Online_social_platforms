  ...
  <div class="wrapper">
    ...
    <article>
      <div class="page whitebg">
        ...
        <div class="page-box">
          <h2 class="page-box-title">私信回复</h2>
          <div class="page-box-content">
            <div>
              ...
              <el-table v-loading="loading" :data="tableData" ref="tableRef" @selection-change="handleSelectionChange">
                <el-table-column label="私信对象" align="center" prop="user.name" min-width="120" :show-overflow-tooltip='true'/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
        <el-form-item label="回复内容" prop="replyCon">
          <el-input v-model="form.replyCon" type="textarea" :rows="3" placeholder="请输入内容" clearable/>
        </el-form-item>
      </el-form>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        this.loading = true;
        this.queryParams.staffId = this.userId
