...
public class LeavesServiceImpl implements LeavesService {
    ...
    // 根据条件查询分页数据
    @Override
    public List<Leaves> selectListByPaging(Integer page, Integer limit,Integer userId, String content, String replyCon, Integer staffId) {
    ...
    // 根据条件查询数据条数
    @Override
    public int selectCountByPaging(Integer userId, String content, String replyCon, Integer staffId) {
