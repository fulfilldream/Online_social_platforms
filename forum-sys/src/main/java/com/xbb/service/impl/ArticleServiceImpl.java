...
public class ArticleServiceImpl implements ArticleService {
    ...
    // 根据条件查询分页数据
    @Override
    public List<Article> selectListByPaging(Integer page, Integer limit,String title, Integer userId, Integer articleTypeId, Integer groupsId, Integer status) {
    ...
    // 根据条件查询数据条数
    @Override
    public int selectCountByPaging(String title, Integer userId, Integer articleTypeId, Integer groupsId, Integer status) {
    ...
    public List<Statistics> selectStatisticsByType() {
        return articleMapper.selectStatisticsByType();
    }

    @Override
    public List<Statistics> selectStatisticsByGroups() {
        return articleMapper.selectStatisticsByGroups();
    }
}
